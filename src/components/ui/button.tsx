...
const buttonVariants = cva(
  ...
  ),
  {
    variants: {
      ...
      size: {
        default: cn('h-touch px-6 py-3', Platform.select({ web: 'has-[>svg]:px-4' })),
        sm: cn('h-10 gap-2 px-4 py-2', Platform.select({ web: 'has-[>svg]:px-3' })),
        lg: cn('h-touch-lg rounded-2xl px-8 py-4', Platform.select({ web: 'has-[>svg]:px-5' })),
