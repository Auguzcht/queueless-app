...
/**
 * Animated tab icon — smooth scale + bg appear on active.
 */
function AnimatedTabIcon({
  ...
  // Sync shared values when focused changes
...
/**
 * Animated tab label — fades + slides up slightly on active.
 */
...
/**
 * Pressable tab button with spring scale feedback.
 */
function AnimatedTabButton({
  ...
  return (
    <Pressable
      onPress={(e) => {
        s.value = withSpring(0.92, { mass: 0.3, stiffness: 300 }, () => {
          s.value = withSpring(1, { mass: 0.3, stiffness: 300 });
        });
        onPress?.(e);
      }}
